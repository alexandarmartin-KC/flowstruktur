        ...
        const mockSections: CVSection[] = [
          {
            ...
            matchNote: 'Profilens fokus på koordinering og stakeholder management matcher jobbets krav. Tilføjet reference til digital transformation baseret på eksisterende erfaring.',
            status: 'pending',
          },
          {
            id: 'erfaring-1',
            name: 'Erfaring: Novo Nordisk',
            originalText: '• Koordinerer tværfaglige projekter mellem R&D, produktion og kvalitet\n• Faciliterer ugentlige statusmøder med 15+ stakeholders\n• Udarbejder projektrapporter til ledelsen\n• Implementeret nyt projektstyringsværktøj (Jira)',
            suggestedText: '• Koordinerer tværfaglige projekter mellem R&D, produktion og kvalitet med fokus på digital understøttelse\n• Faciliterer ugentlige statusmøder med 15+ stakeholders på tværs af organisationen\n• Udarbejder projektrapporter og beslutningsoplæg til ledelsen\n• Implementeret nyt projektstyringsværktøj (Jira) – fra behovsanalyse til udrulning',
            matchNote: 'Erfaringen med tværfaglig koordinering og Jira-implementering er direkte relevant. Fremhævet digital understøttelse.',
            status: 'pending',
          },
          {
            id: 'erfaring-2',
            name: 'Erfaring: Danske Bank',
            originalText: '• Koordinerede compliance-projekter på tværs af afdelinger\n• Ansvarlig for dokumentation og procesoptimering\n• Trænede nye medarbejdere i interne systemer',
            suggestedText: '• Koordinerede compliance-projekter på tværs af afdelinger i reguleret miljø\n• Drev procesoptimering med fokus på effektivisering af arbejdsgange\n• Trænede og onboardede nye medarbejdere i systemer og processer',
            matchNote: 'Compliance-erfaring kan være relevant afhængigt af jobbets kontekst. Procesoptimering fremhævet.',
            status: 'pending',
          },
          {
            id: 'kompetencer',
            ...
            matchNote: 'Kompetencer omstruktureret for bedre match med jobbets fokusområder. Ingen nye kompetencer tilføjet.',
            status: 'pending',
          },
        ];
        setSections(mockSections);
        setUncoveredRequirements([
          'Erfaring med budgetansvar er ikke dokumenteret i CV',
